                ...
                {/* row 1 */}
                  ...
                  {bookings.map((book, index) => (
                    <tr key={book._id || index} className="border-b-2 border-slate-100">
                      {/* Serial Number */}
                      <td className="text-sm lg:text-lg font-bold">{index + 1}</td>
                  
                      {/* Dynamic Data */}
                      <td className="text-sm lg:text-lg font-bold">{book?.gadget}</td>
                      <td className="text-sm lg:text-lg font-bold">{book?.model}</td>
                      <td className="text-sm lg:text-lg font-medium">{book?.problem}</td>
                      <td className="text-sm lg:text-lg font-bold">{book?.date}</td>
                      <td className="text-sm lg:text-lg font-bold">{book?.name}</td>
                      <td className="text-sm lg:text-lg font-bold">{book?.phone}</td>
